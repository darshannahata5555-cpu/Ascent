  ...
  return (
    <PageBackground>
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '40px 28px 80px' }}>
        ...
        <h1 className="display" style={{ fontSize: 56, marginTop: 14, letterSpacing: '-0.02em' }}>How was it?</h1>
        ...
        {/* Active rating card */}
        <div className="glass-strong fade-up" style={{ marginTop: 36, padding: 32 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <span className="chip teal">JUST CONCLUDED</span>
              <div className="display" style={{ fontSize: 34, marginTop: 12, letterSpacing: '-0.02em' }}>Circuit Rush</div>
            </div>
            <div style={{ textAlign: 'right' }}>
              <div style={{ fontFamily: 'var(--f-mono)', fontSize: 11, color: 'var(--ink-mute)', letterSpacing: '0.1em' }}>AGGREGATE</div>
              <div className="display" style={{ fontSize: 28 }}>★ 4.3</div>
          ...
          <div style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 10 }}>
            {events.map((e, i) => (
              <div key={i} className="glass" style={{
                ...
                gridTemplateColumns: '1fr auto auto 140px', alignItems: 'center', gap: 20,
              }}>
                <div>
                ...
                <div style={{ display: 'flex', gap: 2 }}>
                  {[1,2,3,4,5].map(i => <span key={i} style={{ color: i <= e.mine ? 'var(--violet)' : 'var(--ink-faint)' }}>★</span>)}
                </div>
  ...
  return (
    <PageBackground>
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: '40px 28px 80px' }}>
        ...
        <h1 className="display" style={{ fontSize: 56, marginTop: 14, letterSpacing: '-0.02em' }}>Be honest.</h1>
        ...
        <div className="glass-strong fade-up" style={{ marginTop: 36, padding: 34 }}>
          ...
          <div style={{ marginTop: 26, display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 20, borderTop: '1px solid var(--glass-border)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, fontFamily: 'var(--f-mono)', fontSize: 11, color: 'var(--ink-mute)', letterSpacing: '0.1em' }}>
              <span style={{ width: 6, height: 6, borderRadius: '50%', background: 'var(--teal)' }}/> ANONYMOUS · NOT LINKED TO YOU
            </div>
  ...
  return (
    <PageBackground>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '40px 28px 80px' }}>
        ...
        <h1 className="display" style={{ fontSize: 56, marginTop: 14, letterSpacing: '-0.02em' }}>Tell ops.</h1>
        ...
        <div style={{ marginTop: 36, display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 24, alignItems: 'start' }}>
          ...
          <div className="glass-strong" style={{ padding: 30 }}>
            ...
            <div style={{ marginTop: 22, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <button className="btn primary">Send to organizers →</button>
            </div>
          </div>
